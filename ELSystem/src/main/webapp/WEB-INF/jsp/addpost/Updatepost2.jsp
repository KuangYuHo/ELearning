...
<!--                 </select> -->
            ...
            <div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
            	<div class="card mb-2">
                	<h3  style="text-align:center;">編輯貼文</h3>
            	</div>   
            </div>   
            <div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
                <div class="card mb-2">
                <div align="center">
		<form:form method='POST' modelAttribute="addPost" >
			<input type="hidden" name="noname"  id='putOrDelete'   value="" >
    		<c:if test='${AddPost.postId != null}'>
               <form:hidden path="postId" /><br>&nbsp;
			</c:if>
			<fieldset class="fieldset-auto-width">
				...
				<table>
				   <tr>
						<td >分 類： <br>&nbsp;</td>
						<td ><form:input path="postType" /><br>&nbsp;
							<form:errors path="postType" cssClass="error" />
						</td>
					</tr>
					<tr>
						<td align="left">標 題：<br>&nbsp;
						</td>
						<td><form:input path="postTitle" /><br>&nbsp;
					...
					<tr>
						...
						<td><form:textarea  path="postInformation"  id="mPostInformation" style="width: 500px;height:200px;" /><br>&nbsp;
						     <script>
					    CKEDITOR.replace('mPostInformation');
						</script>
						    <form:errors path="postInformation" cssClass="error" />
						</td>
					</tr>
...
<script type="text/javascript">
  function confirmDelete(postId){
	  var result = confirm("確定刪除此筆記錄(編號:" + id.trim() + ")?");
	  if (result) {
