											...
											<div class="simplebar-content" style="padding: 16px;">
												<nav class="nav nav-pills nav-gap-y-1 flex-column">
													<a
														...
														class="nav-link nav-link-faded has-icon active">所有貼文</a> <a
													...
													<a
														...
														class="nav-link nav-link-faded has-icon ">管理留言</a> <a
...
<!-- 							</table> -->
   ...
   function load(indexPage){
	   $.ajax({
		   type:'post',
		   url:'/addpost/searchqueryByPage/' + indexPage,
		   dataType:'JSON',
