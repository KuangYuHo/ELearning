    ...
    <div class="container-fluid mt--7">
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow" style="background-color: #E0E0E0">
            <div class="card-header bg-white border-0" style="background-color: #E0E0E0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">會員資料</h3>
                </div>
                
              </div>
            </div>
            <div class="card-body" style="background-color: #E0E0E0">
              <form:form action="/manage/updateMember.controller" method="post" modelAttribute="uMem">
                <h6 class="heading-small text-muted mb-4">帳戶資料</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">帳號</label><br>
                        <label class="form-control-label" for="input-username">${uMem.account}</label>
                      </div>
                    </div>
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                  	<div class="col-md-12">
                      <div class="form-group focused">
                        <form:label path="authority">權限：</form:label><br>
                 			<form:radiobutton path="authority" value="1" label="會員" /> 
                	 		<form:radiobutton path="authority" value="2" label="老師" />
                			<form:radiobutton path="authority" value="3" label="管理員" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <form action="/manage/managepwd.controller" method="post">
              <div class="row">
				<div class="col-lg-4">
                    <div class="form-group">
						<label class="form-control-label" >新密碼:</label><br>
			  			<input class="form-control form-control-alternative" type="password" id="newpwd" type="password" name="newpwd" value=""><br>
			  		</div>
				</div>
				<div class="col-lg-4">
                      <div class="form-group">
					  	<label class="form-control-label">確認新密碼:</label><br>
					  	<input class="form-control form-control-alternative" type="password" id="checknewpwd" type="password" name="checknewpwd" value=""><br>
			  		  </div>
				</div>
			  </div>
			  	<div class="row">
