...
.inner-main-footer, .inner-main-header, .inner-sidebar-footer,
...
.inner-main-footer, .inner-main-header {
	background-color: #fff;
}
			...
			<div class="inner-wrapper">
				...
				<div class="inner-sidebar">
					...
					<div class="inner-sidebar-header justify-content-center">
						<img src="/assets/img/gallery/logo3.png" height="40" width="200"
							alt="logo" />
					</div>
					<!-- /Inner sidebar header -->
										...
										<div class="simplebar-content-wrapper"
											...
											<div class="simplebar-content" style="padding: 16px;">
												<nav class="nav nav-pills nav-gap-y-1 flex-column">
													<a
														href="http://localhost:8082/addpost/allaction2.controller"
														class="nav-link nav-link-faded has-icon ">所有貼文</a> <a
														href="http://localhost:8082/addpost/allpost.controller"
														class="nav-link nav-link-faded has-icon ">管理貼文</a>
													...
													<a
														href="http://localhost:8082/message/elsmessageList.controller"
														class="nav-link nav-link-faded has-icon active">管理留言</a> <a
														href="http://localhost:8082/addpost/allaction.controller"
														class="nav-link nav-link-faded has-icon">首頁</a>
												</nav>
											</div>
										</div>
									</div>
				...
				<div class="inner-main">
					...
					<div class="inner-main-header">
						...
						<!--                 </select> -->
						搜尋標題:
						<form action="/addpost/searchqueryByPage" method="post">
					...
					<div class="inner-main-body p-2 p-sm-3 collapse forum-content show">
						<div class="card mb-2">
							<div id="allpost">編輯&刪除該貼文的留言</div>
			   ...
			   if(data==null){
				   ...
				   $.each(data, function(i,n){
					   var tr = "<tr align='center'>" +
					            ...
					            "<td><a href='deletemessage?messageId=" + n.messageId + "'>  刪除  </td>" +
					            "<td><a href='updatemessage?messageId=" + n.messageId + "'> 編輯 </td>" 
					            "</tr>";
					   table.append(tr);
				   });			   
			   }
