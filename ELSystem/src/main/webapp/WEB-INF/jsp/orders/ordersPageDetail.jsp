...
function load(indexPage){
	$.ajax({
		type:'post',
		url:'/orders/findallbyorderid/'+ indexPage,
		dataType:'JSON',
		...
		success: function(data){
			...
			if(data==null){
				...
				table.append("<thead><tr align='center'><th>課程圖片</th><th>課程名稱</th><th>課程價格</th></tr></thead>");
				
				$.each(data, function(i,n){
					var tr = "<tbody><tr align='center'>" + "<td><img width='150' src='" + n.lesson.image  + "'></td>" +
							 "<td>" + n.lesson.lessonName + "</td>" +
							 "<td>" + n.lesson.lessonPrice + "</td>" + 
							 "</tr></tbody>";
					table.append(tr);
				});
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title" style="background-color:#FDC800">
                <div class="row">
                    <div class="col-sm-12">
                        <h2><b><font face="serif">訂單明細</font></b></h2>
                    </div>
            ...
            <div class="clearfix">
                <table id="showpage">
					<tr>
						<td>Total Pages:${oddTotalPages } Total Records:${oddTotalElements }</td>
						<td colspan="3" align="right">Previous
							<c:forEach var="i" begin="1" end="${oddTotalPages }" step="1">
