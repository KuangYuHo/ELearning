...
function load(indexPage){
	$.ajax({
		type:'post',
		url:'/orders/shoppingrecord/'+ indexPage,
		dataType:'JSON',
		...
		success: function(data){
			...
			if(data==null){
				...
				table.append("<thead><tr align='center'><th>訂單編號</th><th>付款金額</th><th>付款日期</tr></thead>");
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title" style="background-color:#FDC800">
                <div class="row">
                    <div class="col-sm-12">
                        <h2><b><font face="serif">我的訂單</font></b></h2>
                    </div>
            ...
            <div class="clearfix">
                <table id="showpage">
					<tr>
						<td>Total Pages:${oTotalPages } Total Records:${oTotalElements }</td>
						<td colspan="3" align="right">Previous
							<c:forEach var="i" begin="1" end="${oTotalPages }" step="1">
