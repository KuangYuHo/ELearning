	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="/login/page" method="post">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">帳號</span>
						<input class="input100" id = "loginacc" type="text" name="username" placeholder="Enter username">
					...
					<div class="flex-sb-m w-full p-b-30">
						<div class="contact100-form-checkbox">
							<input class="input-checkbox100" id="ckb1" type="checkbox" name="remeber-me">
					...
					<div class="container-login100-form-btn">
						...
						<button class="login100-form-btn" type="submit" value="login" style="background-color: #FDC800" >Login</button>
			...
			<c:if test="${param.logout != null}">
				...
				<button id="onebtnreg" class="float-right btn btn-outline-primary mt-1">kevin06026</button>
