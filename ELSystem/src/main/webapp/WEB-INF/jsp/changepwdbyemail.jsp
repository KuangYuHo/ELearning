      ...
      <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action = "/changepwdbyemail.controller"  method="post">
					<div class="wrap-input100 validate-input m-b-26" data-validate="新密碼 is required">
						<span class="label-input100">新密碼</span>
						<input class="input100" type="password" name="newpassword" placeholder="Enter username">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "確認密碼 is required">
						<span class="label-input100">確認密碼</span>
						<input class="input100" type="password" name="checknewpassword" placeholder="Enter password">
						<span class="focus-input100"></span>
					</div>	

					<div class="container-login100-form-btn">
						
						<button class="login100-form-btn" type="submit" value="submit" style="background-color: #FDC800" >更改密碼</button>
					</div>
