    		...
    		<div class="table-responsive">
        		<div class="table-wrapper">
        	    	<div class="table-title" style="background-color:#FDC800">
            	    	<div class="row">
                	    	<div class="col-sm-8">
                    	    	<h2 id="articleListTitle"><b><font face="serif">${vArticle.title}</font></b></h2>
                    		</div>
                		</div>
            		</div>
            		<div>
					  ...
					  <div style="background-color: #ffffff">
							      ...
							      <div class="col-12" style="border:1px solid #F5F5F5">${vArticle.content}</div>
						<br>
				    	<a class="btn btn-outline-secondary" href="articlelist.controller">回列表</a>
        			</div>
        		</div>
        	 </div>
       		 </div>
