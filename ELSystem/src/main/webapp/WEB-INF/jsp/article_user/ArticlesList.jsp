...
// 					   });
					   ...
					   $.each(results, function(i,n){
						   var tr = "<div class='col-md-4 mb-4'>"+
						   			"<div class='card h-100'><img class='card-img-top w-100' height='200' src='" +n.image + "' alt='courses' />"+
						   			"<div class='card-body'>"+
						   			"<h5 class='font-sans-serif fw-bold fs-md-0 fs-lg-1'>"+ n.title +"</h5><a class='text-muted fs--1 stretched-link text-decoration-none' href='viewarticle.controller?id=" + n.articleId + "'>"+ n.classification +"</a>"+
						   			"</div>"+
						   			"</div>"+
						   			"</div>"
 ...
 <body>
    ...
    <!-- <section> begin ============================-->
    	<div class="container-xl">
    		<div class="table-responsive">
        		<div class="table-wrapper">
        	    	<div class="table-title" style="background-color:#FDC800">
            	    	<div class="row">
                	    	<div class="col-sm-8">
                    	    	<h2 id="articleListTitle"><b><font face="serif">好文分享</font></b></h2>
                    		</div>
                		</div>
            		</div>
					<br>
            	    ...
            	    <div class="col-sm-4">
                    	搜尋文章：<input id="keywords" name="keywords" type='text'>
			...
			<div>
        		<div class="container">
       			   <div class="row" id="showarticle"></div>
      			</div>
        <!-- end of .container-->
