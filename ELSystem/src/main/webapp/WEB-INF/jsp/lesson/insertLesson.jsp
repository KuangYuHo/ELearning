        		...
        		<div class="table-wrapper">
            		...
            		<div>
	      			...
	      			<div class="col-md-7 col-lg-8">
		   			...
		   			<br>
		   			<h4 class="mb-3">InsertArticle</h4>

	          			<div class="row g-3">

	            			<div class="col-12">
              				 <label for="aTitle" class="form-label">Lesson Name</label>
              				 <input type="text" class="form-control" name="lessonName" id="aTitle" required>
						    ...
						    <div class="col-12">
	              				<label for="aAuthor" class="form-label">Lesson Price</label>
	              				<input type="text" class="form-control" name="lessonPrice" id="aAuthor" required>
	              				<div class="invalid-feedback">
	                				Please enter Lesson Price.
	              				</div>
	             				<div>
	                				${errors.lessonPrice}
	              				</div>
	            	...
	            	<!--加上上傳圖片-->
	          		...
	          		<button class="w-100 btn btn-primary btn-lg" type="submit">Insert</button>          
