		   ...
		   $.ajax({
			   ...
			   success: function(data){
				   ...
				   if(results===null || results.length === 0){
					   ...
					   table.append("<thead><tr id='atitle'><th>ID</th><th>課程名稱</th><th>價錢</th><th>編輯</th></tr></thead>");
					   ...
					   $.each(results, function(i,n){
						   var tr = "<tbody><tr align='left'>" + 
						            ...
						            "<td>" + n.lessonName + "</td>" +
						            "<td>" + n.lessonPrice + "</td>" +
						            "<td><a href='getlesson.controller?id=" + n.lessonId + "'> 編輯 </td>" +
    		...
    		<div class="table-responsive">
        		<div class="table-wrapper">
        	    	<div class="table-title" style="background-color:#FDC800">
            	    	<div class="row">
                	    	<div class="col-sm-8">
                    	    	<h2 id="articleListTitle">Article Manager</h2>
                    		</div>
                		</div>
            		</div>
					<br>
					...
					<form>
					<input type="submit" value="新增課程" onclick='this.form.action="insertlessonform.controller"' />
					</form>
					<br>
