...
$(document).ready(function(){	   
 ...
 <body>
	...
	<section class="bg-primary py-2 d-none d-sm-block">
	  ...
	  <!--form start-->
	  <form action="updatelesson.controller" enctype="multipart/form-data" method="post">
	    		...
	    		<div class="table-responsive">
	        		<div class="table-wrapper">
	        	    	<div class="table-title" style="background-color:#FDC800">
	            	    	<div class="row">
	                	    	<div class="col-sm-8">
	                    	    	<h2 id="articleListTitle">Lesson Manager</h2>
	                    		</div>
	                		</div>
	            		</div>
	            		<div>
						...
						<div style="background-color: #ffffff">
		   				<br>
						<h4 class="mb-3">UpdateArticle</h4>
						
				        <form class="needs-validation" novalidate>
				          <div class="row g-3">
				          
				          	<div class="col-12">
				          	 <label for="aId" class="form-label">LessonId</label>
				          	 <input type="text" class="form-control" name="lessonId" value="${upLesson.lessonId}" required>
							</div>
				
				          	<div class="col-12">
				          	  <label for="aTitle" class="form-label">Article Title</label>
				              <input type="text" class="form-control" name="lessonName" id="aTitle" value="${upLesson.lessonName}" placeholder="Title" required>
							...
							<div class="col-12">
				              <label for="aAuthor" class="form-label">Price</label>
				              <input type="text" class="form-control" name="lessonPrice" id="aAuthor" value="${upLesson.lessonPrice}" placeholder="Author" required>
				              <div class="invalid-feedback">
				                Please enter Price.
				              </div>
				              <div>
