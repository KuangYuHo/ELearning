...
<body>
	...
	<section class="bg-primary py-2 d-none d-sm-block">
	  ...
	  <!--form start-->
	  <form action="viewarticle.controller" method="post">
        		...
        		<div class="table-wrapper">
        	    	<div class="table-title" style="background-color:#FDC800">
					  ...
					  <div style="background-color: #ffffff">
			   			<br>
			   			<h5 class="mb-3"><font face="serif"><b>已成功新增文章</b></font></h5>
	
		              		<dl class="row" >
							  <dt class="col-sm-3">文章標題：</dt>
							  <dd class="col-sm-9">${aTitle}</dd>
							
							  <dt class="col-sm-3">作者：</dt>
							  <dd class="col-sm-9">${aAuthor}</dd>
							
							  <dt class="col-sm-3">分類：</dt>
							  <dd class="col-sm-9">${aClassification}</dd>
							  
							  <dt class="col-sm-3">文章縮圖：</dt>
							  <dd class="col-sm-9"><img class="img-thumbnail" height='50px' src='${image}'></dd>
							
							  <dt class="col-sm-3">文章內容：</dt>
							  <dd class="col-sm-9">
							      <div class="col-12" style="border:1px solid #F5F5F5">${aContent}</div>
							  </dd>
								
							  <dt class="col-sm-3">下架日期：</dt>
							  <dd class="col-sm-9">${aExpiredDate}</dd>
							</dl>

				        	<br>
							<a class="btn btn-primary me-2" href="insertarticleform.controller"'>新增下一筆</a>
