...
.sub-menu a:hover { color:#000000; background-color:#FFD306; text-decoration:none; }
	...
	<script type="text/javascript">
		   ...
		   $.ajax({
			   ...
			   success: function(data){
				   ...
				   if(results===null || results.length === 0){
					   ...
					   table.append("<thead><tr id='atitle'><th>ID</th><th>文章標題</th><th>分類</th><th>建立日期</th><th>下架日期</th><th>編輯</th><th>刪除</th></tr></thead>");
					   ...
					   $.each(results, function(i,n){
						   var tr = "<tbody><tr align='left'>" + 
						            ...
						            "<td>" + n.createDate + "</td>" +
						            "<td>" + n.expiredDate + "</td>" +
						            "<td><a href='getarticle.controller?id=" + n.articleId + "'> 編輯 </td>" +
						            "<td><a href='#!' title='up' onclick='DataOK("+ n.articleId +")'> 刪除 </td>" 
						            "</tr></tbody>";
						   table.append(tr);
					   });	
	   ...
	   function DataOK(id){
		   $.ajax({
			   type:'get',
			   url:'deletearticle.controller?id='+id,
			   dataType:'JSON',
			   contentType:'application/json',
			   success: function(data){
				   alert('刪除成功');
    	...
    	<div class="container-xl">
    		<div class="table-responsive">
        		<div class="table-wrapper">
					...
					<div align='right'>
						<form>
							<input class="btn btn-primary btn-sm" type="submit" value="新增文章" onclick='this.form.action="insertarticleform.controller"' />
						</form>
					</div>
					<br>
