...
$(document).ready(function(){	   
 ...
 <body>
	...
	<section class="bg-primary py-2 d-none d-sm-block">
	  ...
	  <!--form start-->
	  <form action="updatearticle.controller" enctype="multipart/form-data" method="post">
	    		...
	    		<div class="table-responsive">
	        		<div class="table-wrapper">
	        	    	<div class="table-title" style="background-color:#FDC800">
	            	    	<div class="row">
	                	    	<div class="col-sm-8">
	                    	    	<h2 id="articleListTitle"><b><font face="serif">文章管理</font></b></h2>
	                    		</div>
	                		</div>
	            		</div>
	            		<div>
						...
						<div style="background-color: #ffffff">
		   				<br>
						<h4 class="mb-3"><font face="serif"><b>修改文章</b></font></h4>
				        ...
				        <form class="needs-validation" novalidate>
				          <div class="row g-3">
				          	...
				          	<div class="col-12">
				          	 ...
				          	 <input type="text" class="form-control" name="aId" value="${upArticle.articleId}" required>
							</div>
				
				          	<div class="col-12">
				          	  <label for="aTitle" class="form-label">文章標題</label>
				              <input type="text" class="form-control" name="aTitle" id="aTitle" value="${upArticle.title}" placeholder="Title" required>
							...
							<div class="col-12">
				              <label for="aAuthor" class="form-label">作者</label>
				              <input type="text" class="form-control" name="aAuthor" id="aAuthor" value="${upArticle.author}" placeholder="Author" required>
				              <div class="invalid-feedback">
				                Please enter Author.
				              </div>
				              <div>
							...
							<div class="col-md-5">
				              <label for="aClassification" class="form-label">分類</label>
				              <select class="form-select" name="aClassification" id="aClassification" required>
				           	 	<option value="${upArticle.classification}">${upArticle.classification}</option>
					                <option value="兒童文學">兒童文學</option>
									<option value="創意想像">創意想像</option>
									<option value="自然生態">自然生態</option>
									<option value="藝術美勞">藝術美勞</option>
				          	...
				          	<!--加上上傳圖片-->
				           	<div class="col-12">
				              <label for="aImage" class="form-label">文章縮圖</label>
				        	...
				        	<div class="col-12">
								<label for="aContent" class="form-label">文章內容</label>
								<textarea class="form-control" name="aContent" id="aContent" rows="10" cols="80" value="${upArticle.content}"></textarea>
									<script>
							...
							<div class="col-12">
								<label for="aExpiredDate" class="form-label">下架日期</label>
								<input type="date" class="form-control" name="aExpiredDate" id="aExpiredDate" value="${upArticle.expiredDate}" placeholder="1234 Main St" required>
								<div class="invalid-feedback">
								  Please enter Date.
								</div>
								<div>
						...
						<div class="col-12">
		          		...
		          		<button class="btn btn-primary me-2" type="submit">送出</button>
		          		<a class="btn btn-outline-secondary" href="showarticle.controller"'>取消</a>     
				        </form>
