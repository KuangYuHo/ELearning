...
$(document).ready(function(){	   
 ...
 <body>
	...
	<!--form start-->
	<form action="insertarticle.controller" enctype="multipart/form-data" method="post">
        		...
        		<div class="table-wrapper">
            		...
            		<div>
	      			...
	      			<div class="col-md-7 col-lg-8">
		   			...
		   			<br>
		   			<h4 class="mb-3"><font face="serif"><b>新增文章</b></font></h4>
	         			...
	         			<form class="needs-validation" novalidate>
	          			<div class="row g-3">
						    ...
						    <div class="col-12">
	              				...
	              				<input type="text" class="form-control" name="aAuthor" id="aAuthor" required>
	              				<div class="invalid-feedback">
	                				Please enter Author.
	              				</div>
	             				<div>
	            	...
	            	<!--加上上傳圖片-->
							...
							<div class="col-12">
							   ...
							   <textarea class="form-control" name="aContent" id="aContent" rows="10" cols="80"></textarea>
									<script>
							...
							<div class="col-12">
								...
								<input type="date" class="form-control" name="aExpiredDate" id="aExpiredDate" placeholder="1234 Main St" required>
								<div class="invalid-feedback">
								  Please enter Date.
								</div>
								<div>
